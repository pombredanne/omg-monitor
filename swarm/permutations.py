...
'/home/allan/Git/nupic/build/release/lib/python2.7/site-packages/nupic/frameworks/opf/exp_generator/ExpGenerator.py'
"""
...
permutations = {
  ...
  u'status': PermuteEncoder(fieldName='status', encoderClass='SDRCategoryEncoder', w=21, n=121, ),
  u'responsetime': PermuteEncoder(fieldName='responsetime', w=21, clipInput=False, minval=0, maxval=60000, encoderClass='ScalarEncoder', n=PermuteInt(22, 621), ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=responsetime")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=responsetime"
